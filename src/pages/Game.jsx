      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 12px' }}>
        ...
        {tab === 'admin' && isSuperAdmin && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 16 }}>
              <div style={{ fontWeight: 700, fontSize: 15, color: '#e8eaf0', marginBottom: 14 }}>Introducir resultados en todos los grupos</div>
              <div style={{ fontSize: 12, color: '#f4a261', marginBottom: 12 }}>Los resultados se guardarán en TODOS los grupos a la vez</div>
